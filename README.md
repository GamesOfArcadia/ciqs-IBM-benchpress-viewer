CIQS Benchmark Viewer

A lightweight single-file HTML viewer for IBM Benchpress JSON output.
Drop a Benchpress result file onto the page and get an immediate visual breakdown of your benchmark run.
